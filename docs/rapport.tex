...
\author{
    ...
    Groupe 2: \textbf{Awa Ndiaye, Mouhamed Lamine Faye} \\
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{images/small-file-local/script-launch.png}
\caption{Exécution locale sur le fichier 20251208.export.CSV}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.9\textwidth]{images/small-file-local/script-launch-results.png}
\caption{Résultats de l'exécution locale}
\end{figure}
